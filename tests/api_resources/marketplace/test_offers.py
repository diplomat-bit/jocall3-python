...
class TestOffers:
    ...
    @parametrize
    def test_method_list_offers(self, client: Garbage) -> None:
        offer = client.marketplace.offers.list_offers()
        assert_matches_type(OfferListOffersResponse, offer, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_list_offers(self, client: Garbage) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_list_offers(self, client: Garbage) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_redeem_offer(self, client: Garbage) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_redeem_offer(self, client: Garbage) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_redeem_offer(self, client: Garbage) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_redeem_offer(self, client: Garbage) -> None:
...
class TestAsyncOffers:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_list_offers(self, async_client: AsyncGarbage) -> None:
        offer = await async_client.marketplace.offers.list_offers()
        assert_matches_type(OfferListOffersResponse, offer, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_list_offers(self, async_client: AsyncGarbage) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_list_offers(self, async_client: AsyncGarbage) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_redeem_offer(self, async_client: AsyncGarbage) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_redeem_offer(self, async_client: AsyncGarbage) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_redeem_offer(self, async_client: AsyncGarbage) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_redeem_offer(self, async_client: AsyncGarbage) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `offer_id` but received ''"):
