...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "Garbage", "AsyncGarbage", "Client", "AsyncClient"]


class Garbage(SyncAPIClient):
    # client options
    api_key: str | None
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Garbage client instance.

        This automatically infers the `api_key` argument from the `GARBAGE_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("GARBAGE_API_KEY")
        self.api_key = api_key

        if base_url is None:
            base_url = os.environ.get("GARBAGE_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> GarbageWithRawResponse:
        return GarbageWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> GarbageWithStreamedResponse:
        return GarbageWithStreamedResponse(self)
...
class AsyncGarbage(AsyncAPIClient):
    # client options
    api_key: str | None
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncGarbage client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncGarbageWithRawResponse:
        return AsyncGarbageWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncGarbageWithStreamedResponse:
        return AsyncGarbageWithStreamedResponse(self)
...
class GarbageWithRawResponse:
    _client: Garbage

    def __init__(self, client: Garbage) -> None:
        self._client = client
...
class AsyncGarbageWithRawResponse:
    _client: AsyncGarbage

    def __init__(self, client: AsyncGarbage) -> None:
        self._client = client
...
class GarbageWithStreamedResponse:
    _client: Garbage
...
class AsyncGarbageWithStreamedResponse:
    _client: AsyncGarbage
