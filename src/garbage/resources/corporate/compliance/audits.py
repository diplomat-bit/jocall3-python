...
from ....types.corporate.compliance import audit_request_audit_params
from ....types.corporate.compliance.audit_request_audit_response import AuditRequestAuditResponse
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                audit_request_audit_params.AuditRequestAuditParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=AuditRequestAuditResponse,
        )
...
class AuditsResourceWithRawResponse:
    def __init__(self, audits: AuditsResource) -> None:
        ...
        self.request_audit = to_raw_response_wrapper(
...
class AsyncAuditsResourceWithRawResponse:
    def __init__(self, audits: AsyncAuditsResource) -> None:
        ...
        self.request_audit = async_to_raw_response_wrapper(
            audits.request_audit,
        )
...
class AuditsResourceWithStreamingResponse:
    def __init__(self, audits: AuditsResource) -> None:
        ...
        self.request_audit = to_streamed_response_wrapper(
            audits.request_audit,
        )
...
class AsyncAuditsResourceWithStreamingResponse:
    def __init__(self, audits: AsyncAuditsResource) -> None:
        ...
        self.request_audit = async_to_streamed_response_wrapper(
            audits.request_audit,
        )
