...
<!-- prettier-ignore -->
[![PyPI version](https://img.shields.io/pypi/v/jocall3.svg?label=pypi%20(stable))](https://pypi.org/project/jocall3/)
...
> [!NOTE]
> Once this package is [published to PyPI](https://www.stainless.com/docs/guides/publish), this will become: `pip install jocall3`
...
```sh
# install from the production repo
pip install 'jocall3[aiohttp] @ git+ssh://git@github.com/diplomat-bit/jocall3-python.git'
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/diplomat-bit/jocall3-python/issues) with questions, bugs, or suggestions.
